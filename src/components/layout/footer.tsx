    ...
    <div className="bg-dark text-center pb-1" id="footer">
      <div className="d-inline-flex mt-2">
        <a
          ...
          rel="noreferrer"
        >
          <h4 className="socialMediaButton mx-3 font-weight-bold text-white">
            <BsGithub />
          </h4>
        </a>
        <a
          href="https://www.linkedin.com/in/bruno-tatsuya/"
          target="_blank"
          rel="noreferrer"
        >
          <h4 className="socialMediaButton mx-2 font-weight-bold text-white">
            <BsLinkedin />
          </h4>
        </a>
        <a
